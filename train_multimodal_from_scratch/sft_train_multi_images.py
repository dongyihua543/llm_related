...
if __name__ == '__main__':
    ...
    images_path = '/home/user/wyf/train_multimodal_from_scratch/dataset'
    data_path = '/home/user/wyf/train_multimodal_from_scratch/dataset/train-00000-of-00001.parquet'
